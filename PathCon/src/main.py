...
def main():
    ...
    parser.add_argument('--inductive', action='store_true',
                        help='Whether to do inductive')
    parser.add_argument('--ratio', type=float, default=0,
                        help='Ratio of remove nodes for an inductive scenario')
    parser.add_argument('--partially_inductive', action='store_true',
                        help='Whether to do partially inductive')
    parser.add_argument('--inductive_edges', type=int, default=0,
                        help='Number of edges remained in an inductive scenario')
